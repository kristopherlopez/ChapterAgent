...
COMPLIANCE_COMPONENTS: list[dict[str, Any]] = [
    ...
    {"id": "compliance-audit-trail", "name": "Audit Trail Check (AI-GOV-008)", "description": "Validates execution traces exist for 100% of golden dataset cases", "interface": {"squad_provides": "Trace directory with run files", "component_returns": "PASS/FAIL with trace coverage percentage"}},
