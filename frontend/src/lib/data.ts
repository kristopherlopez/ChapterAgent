...
export const catalogComponents: CatalogComponent[] = [
  ...
  },
  {
    ...
    type: "compliance",
    description: "AI-GOV-008: Validates that execution traces exist for 100% of golden dataset test cases. Ensures every decision is traceable for regulatory audit.",
    interface: { squadProvides: "Trace directory with run files", componentReturns: "PASS/FAIL with trace coverage percentage" },
    adoption: allSolutionIds,
    status: "active",
  },
  {
