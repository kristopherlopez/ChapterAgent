...
| **Model Owner** | The individual accountable for the model's performance, compliance, and business outcomes. The model owner is typically the team lead or product owner responsible for the AI solution that contains the model. |
