...
|---|----------|------|-----------|-------------|
| 1 | Q&A Agent | RAG | `production_customer_facing` | Answers questions about CBA's 2025 Annual Report with citations. Implemented in Claude SDK, OpenAI SDK, and LangChain. |
