...
| AI-GOV-007 | Bias & Fairness | Solutions must not exhibit systematic demographic bias; bias score must be within risk-tier threshold | Layer 1 (Deployment Gate) + Layer 2 (Production) | Preventive + Detective | AIR-002 | DISR #4 (testing), PetSure Australia Group AI Policy (fairness) | [06](06-guardrails.md), [08](08-evaluation-harness.md) |
